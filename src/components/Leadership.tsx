...
export function Leadership() {
  return (
    <section className="my-32 text-left">
      ...
      <p className="max-w-3xl text-justify text-2xl leading-snug font-medium tracking-tight text-zinc-300">
        Liderei uma equipe com mais dois desenvolvedores, trabalho que me rendeu
        o estágio e a bolsa no curso da{" "}
